...
import 'syntax_lab.dart';

int sum(int numOne, [int numTwo = 0]) => numOne + numTwo;
...
void main() {
  ...
  Set<int> beigeColor = blueColor.map((item) => item == 45 ? 255 : item).toSet();

  assert(blueColor.length == 3);
  print(beigeColor);

  List fibonacciNumbers = [1, 1, 2, 3, 5, 8, 13, 21, 34];
  print(fibonacciNumbers);
  print(fibonacciNumbers.reduce((value, element) => value + element));
  List fibonacciNumbersGreeceStart = [0, ...fibonacciNumbers];
  print(fibonacciNumbersGreeceStart);
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'TI-81 Halych Dmytro'),
    );
  }
}
